...
{
    if (data.patient) personalInfo.isPatient = true;

    if (data.doctor) personalInfo.isDoctor = true;

    if (data.name_walletDoctor && data.name_walletPatient)
    {
        personalInfo.nameWallet = {
            doctor: data.name_walletDoctor,
            patietn: data.name_walletPatient,
        };
        personalInfo.id = {
    ...
    personalInfo.nameWallet = data.name_walletPatient
        ? data.name_walletPatient
        : data.name_walletDoctor;
