...
module.exports =
{
    ...
    getAllPatient:"Select Patient.id,surname,name,lastname, City.city as city, mail, account_wallet,list_doctors_have_access as list_doc FROM Patient INNER JOIN City ON City.id = Patient.city_id",
